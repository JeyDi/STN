...
def print_stats(G):
    ...
    exposed_directed = cn.count_exposed_directed(G)
    ...
    infected_directed = cn.count_infected_directed(G)
    ...
    print(f'\tDirected: {exposed_directed["directed"]}, Undirected: {exposed_directed["undirected"]}')
    ...
    print(f'\tDirected: {infected_directed["directed"]}, Undirected: {infected_directed["undirected"]}')
